...
#Room
    ...
    path("asset_app/room/may_be_loaned_true/<int:pk>/<int:link_id>/", views.RoomDetailView.may_be_loaned_true, name="asset_app_room_may_be_loaned_true"),
    path("asset_app/room/may_be_loaned_false/<int:pk>/<int:link_id>/", views.RoomDetailView.may_be_loaned_false, name="asset_app_room_may_be_loaned_false"),
