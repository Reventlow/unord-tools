...
#Asset
    ...
    path("asset_app/asset/addMonthToLoan/<int:pk>/", views.AssetDetailView.addMonthToReturnDate, name="asset_app_asset_add_month_to_loan"),
...
#LoanAsset
    ...
    path("asset_app/loan_asset/return/filter/<loc_name>/<return_date>/<returned>/<task>/", views.Loan_assetListFilterView.as_view(), name="asset_app_loan_asset_list_filter"),
