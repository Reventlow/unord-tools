...
class Language(object):
    ...
    :type alphabet: str
    :ivar wiki_start_pages: The Wikipedia pages_app to start from if we're crawling
...
LANGUAGES = {'Arabic': Language(name='Arabic',
             ...
             # simple way to get the Latin alphabet pages_app from Wikipedia through
             ...
             'Vietnamese': Language(name='Vietnamese',
                                    ...
                                    # dozens of 8-bit Vietnamese code pages_app are
